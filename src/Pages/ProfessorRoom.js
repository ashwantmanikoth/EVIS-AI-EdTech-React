      ...
      <div className="page-container">
        <div className="room-id-display">
          ...
          <div className="horizontal-container">
            ...
            <button className="btn-create-room" onClick={handleExitRoom}>Exit Room</button>
            <button className="btn-create-room" onClick={handleDeleteRoom}>Delete Room</button>
          </div>
          ...
          {quizNumber != -1 ? (
            ...
            <div className="horizontal-container">
                ...
                <button className="btn-create-room" onClick={handleEndQuiz}>End Quiz</button>
              </div>
            </div>
          ) : (
            <div >
              <p>No ongoing quizes!</p>
              <button className="btn-create-room" onClick={handleStartQuiz}>Start Quiz</button>
            </div>
          )}
        </div>
